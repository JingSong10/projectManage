...
SECRET_KEY = 'cz7xo&v+=35feplrsnuf^^1zsw)artevxo_0jlrh#su28qt(%q'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
                'all_project_list': 'web.templatetags.project',
            },
        },
    },
]
...
try:
    from saas_platform.local_settings import *
